...
set CATALINA_OPTS=-Xdebug -Xrunjdwp:transport=dt_socket,address=8001,server=y,suspend=n
...
set COERCE_TO_ZERO="-Dorg.apache.el.parser.COERCE_TO_ZERO=false"
:gotJsseOpts
set "JAVA_OPTS=%JAVA_OPTS% %JSSE_OPTS% %COERCE_TO_ZERO%"
